    ...
    <div className="w-full h-full relative flex flex-col items-center justify-between">
      ...
      <header className=" z-10 bg-white fixed top-10 w-1/2 rounded-lg flex p-3 justify-center items-center">
        ...
        <form className="flex gap-3 w-full" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="flex justify-center align-middle w-36 bg-[rgb(185,56,120)] hover:bg-[rgb(78,35,56)] rounded-lg hover:fill-cyan-500 transition-all fill-white"
          >
            <svg
              className=" p-2 w-10"
        ...
        </form>} {isLoading&&<img src="./Ghost.gif"></img>
        }
        {isDone&&result} W/m²
      </header>
